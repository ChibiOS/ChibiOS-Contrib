 ...
 */
static uint8_t increment_var = 0;

/*
 * USB Device Descriptor.
 */
static const uint8_t hid_device_descriptor_data[] = {
  USB_DESC_DEVICE       (0x0110,        /* USB version (1.1).                */
                         0x00,          /* Device class.                     */
...
static const uint8_t hid_configuration_descriptor_data[] = {
  /* Configuration Descriptor.*/
  USB_DESC_CONFIGURATION(41,            /* Total length.                           */
...
static const uint8_t usb_string_langid[] =
    USB_DESC_STRING(USB_DESC_WORD(0x0409)); /* U.S. English language.*/
 ...
 * @return              Number of report bytes in the data buffer.
 *
 * @notapi
 */
...
/**
 * @brief   USB HID driver configuration.
 */
