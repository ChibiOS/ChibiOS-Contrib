...
/*===========================================================================*/
/* SK32 SLED driver related settings.                                        */
/*===========================================================================*/

/**
 * @brief   Enables the SK32 SLED subsystem.
 * @note    This switch is not part of the generic ChibiOS halconf template:
 *          the SLED controller is a 3Think peripheral found on the SK32F077
 *          only.  The platform header (hal_lld.h) derives the
 *          SK32_DMA_REQUIRED macro from it so that the DMA1 helper code and
 *          the DMA1 initialization are included in the build.
 */
#if !defined(HAL_USE_SLED) || defined(__DOXYGEN__)
#define HAL_USE_SLED                        TRUE
#endif
