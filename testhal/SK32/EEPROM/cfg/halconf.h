 ...
 * @note    ENABLED for this test: it is the backing store used by the QMK
 *          wear-leveling EEPROM on the SK32F077.  The test proves that a
 *          value written at the tail of the internal flash is still readable
 *          after a reset (cross-reset persistence).
 */
