...
int main(void) {
  ...
  GPIO->EUSARTROUTE[0].TXROUTE = (2 << _GPIO_EUSART_TXROUTE_PORT_SHIFT)
                                 | (2 << _GPIO_EUSART_TXROUTE_PIN_SHIFT);
  GPIO->EUSARTROUTE[0].RXROUTE = (2 << _GPIO_EUSART_RXROUTE_PORT_SHIFT)
  ...
  GPIO->EUSARTROUTE[1].TXROUTE = (2 << _GPIO_EUSART_TXROUTE_PORT_SHIFT)
                                 | (2 << _GPIO_EUSART_TXROUTE_PIN_SHIFT);
  GPIO->EUSARTROUTE[1].RXROUTE = (2 << _GPIO_EUSART_RXROUTE_PORT_SHIFT)
                                 | (1 << _GPIO_EUSART_RXROUTE_PIN_SHIFT);
  ...
  GPIO->EUSARTROUTE[2].TXROUTE = (2 << _GPIO_EUSART_TXROUTE_PORT_SHIFT)
                                 | (2 << _GPIO_EUSART_TXROUTE_PIN_SHIFT);
  GPIO->EUSARTROUTE[2].RXROUTE = (2 << _GPIO_EUSART_RXROUTE_PORT_SHIFT)
                                 | (1 << _GPIO_EUSART_RXROUTE_PIN_SHIFT);
  GPIO->EUSARTROUTE[2].ROUTEEN = GPIO_EUSART_ROUTEEN_RXPEN | GPIO_EUSART_ROUTEEN_TXPEN;
