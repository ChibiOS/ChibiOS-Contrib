 ...
 */
typedef struct SCSISense PACKED_VAR {
  uint8_t byte[18];
 ...
 * @details See SCSI specification.
 */
typedef struct SCSIInquiry PACKED_VAR {
  uint8_t peripheral;
  uint8_t removable;
  uint8_t version;
 ...
 * @details See SCSI specification.
 */
typedef struct SCSIUnitSerial PACKED_VAR {
  uint8_t peripheral;
  uint8_t page_code;
  uint8_t reserved;
  uint8_t page_length;
 ...
 * @details See SCSI specification.
 */
typedef struct SCSIModeSenseRequest PACKED_VAR {
  uint8_t   byte[6];
 ...
 * @details See SCSI specification.
 */
typedef struct SCSIModeSenseResponse PACKED_VAR {
  uint8_t   byte[4];
 ...
 * @details See SCSI specification.
 */
typedef struct SCSIReadCapacity PACKED_VAR {
 ...
 * @details See SCSI specification.
 */
typedef struct SCSIReadFormat PACKED_VAR {
  uint8_t header[4];
  uint8_t blocknum[4];
  uint8_t blocklen[4];
