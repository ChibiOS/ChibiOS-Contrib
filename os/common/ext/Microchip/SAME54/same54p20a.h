...
#  define _UINT8_(x)   (x)    /* C code: 8-bits unsigned integer constant value */
#  define _UINT16_(x)  (x)   /* C code: 16-bits unsigned integer constant value */
#  define _UINT32_(x)  (x)   /* C code: 32-bits unsigned integer constant value */
