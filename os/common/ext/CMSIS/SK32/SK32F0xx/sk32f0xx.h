/**
  ...
  *          definitions and memory mapping for SK32F0xx devices.
  *
...
#if !defined  (PLL48_VALUE)
#define PLL48_VALUE ((uint32_t)48000000) /*!< Value of the Internal High Speed oscillator for USB in Hz.
                                             The real value may vary depending on the variations
                                             in voltage and temperature.  */
#endif /* PLL48_VALUE */
...
/**
 * @brief SK32F0xx Standard Peripheral Library version number V1.0.0
   */
#define __SK32F0XX_STDPERIPH_VERSION_MAIN   (0x01) /*!< [31:24] main version */
#define __SK32F0XX_STDPERIPH_VERSION_SUB1   (0x00) /*!< [23:16] sub1 version */
#define __SK32F0XX_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version */
#define __SK32F0XX_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */
#define __SK32F0XX_STDPERIPH_VERSION        ((__SK32F0XX_STDPERIPH_VERSION_MAIN << 24)\
                                             |(__SK32F0XX_STDPERIPH_VERSION_SUB1 << 16)\
                                             |(__SK32F0XX_STDPERIPH_VERSION_SUB2 << 8)\
                                             |(__SK32F0XX_STDPERIPH_VERSION_RC))
...
/**
 * @brief SK32F0xx Interrupt Number Definition, according to the selected device
 *        in @ref Library_configuration_section
 */
#define __CM0_REV                 0 /*!< Core Revision r0p0                           */
#define __MPU_PRESENT             0 /*!< SK32F0xx do not provide MPU                  */
#define __NVIC_PRIO_BITS          2 /*!< SK32F0xx uses 2 Bits for the Priority Levels */
...
typedef enum IRQn {
    ...
    DMA1_Channel4_5_6_IRQn      = 11,     /*!< DMA1 Channel 4, Channel 5, Channel 6 Interrupts               */
    ADC_COMP_IRQn               = 12,     /*!< ADC1, COMP1 and COMP2 Interrupts                              */
    ...
    SLED_IRQn                   = 29,     /*!< SLED Interrupts                                               */
    KBCU_IRQn                   = 30,     /*!< KBCU Interrupts                                               */
...
typedef struct {
    ...
    __IO uint32_t VREFSR;       /*!< ADC Vref register,                                         Address offset:0x44 */
} ADC_TypeDef;
...
typedef struct {
    __IO uint32_t CCR;           /*!< DMA channel x configuration register                     Address offset: 0x00 */
    __IO uint32_t CNDTR;         /*!< DMA channel x number of data register                    Address offset: 0x04 */
    __IO uint32_t CPAR;          /*!< DMA channel x peripheral address register                Address offset: 0x08 */
    __IO uint32_t CMAR;          /*!< DMA channel x memory address register                    Address offset: 0x0C */
} DMA_Channel_TypeDef;
...
typedef struct {
    ...
    __IO uint32_t EOBR;          /*!<Extention FLASH option bytes register,                    Address offset: 0x24 */
         uint32_t RESERVED0[6]; /*!< Reserved as declared by channel typedef                           0x28 - 0x3C */  
...
typedef struct {
    ...
    __IO uint16_t EUSER;         /*!< Extension option byte user options,                      Address offset: 0x10 */
} OB_TypeDef;
...
typedef struct {
    ...
    uint32_t RESERVED;           /*!< Reserved,                                                                0x2C */
    __IO uint16_t CSR;           /*!< GPIO Input mode selection register,                      Address offset: 0x30 */
    uint16_t RESERVED4;          /*!< Reserved,                                                                0x32 */
    __IO uint32_t DCR[2];        /*!< GPIO Current configuration low/high register,       Address offset: 0x34-0x38 */
} GPIO_TypeDef;
...
typedef struct {
    ...
    uint32_t RESERVED1[5];       /*!< Reserved                                                           0x2C- 0x1C */
    uint32_t CFGR3;              /*!< SYSCFG configuration register 3,                         Address offset: 0x30 */
    uint32_t CFGR4;              /*!< SYSCFG configuration register 4,                         Address offset: 0x34 */
} SYSCFG_TypeDef;  
...
typedef struct {
    ...
    __IO uint32_t SUPR;          /*!< PWR stanby up register,                                  Address offset: 0x08 */
} PWR_TypeDef;
...
typedef struct {
    ...
    __IO uint32_t BDCR;          /*!< RTC Backup domain control register,                      Address offset: 0x20 */
...
/**
  ...
  */
typedef struct {
    __IO uint32_t CR1;           /*!< TSC control register1,                                   Address offset: 0x00 */
    __IO uint32_t CR2;           /*!< TSC control register2,                                   Address offset: 0x04 */
    __IO uint32_t IER;           /*!< TSC interrupt enable register,                           Address offset: 0x08 */
    __IO uint32_t SR;            /*!< TSC status register,                                     Address offset: 0x0C */
    __IO uint32_t OTSR;          /*!< TSC overflow Status register,                            Address offset: 0x10 */
    __IO uint32_t CHENR;         /*!< TSC channel enable register,                             Address offset: 0x14 */
    __IO uint32_t IRTEMR;        /*!< TSC configures IDAC current trim value,                  Address offset: 0x18 */
    __IO uint32_t VRTEMR;        /*!< TSC voltage trim value register,                         Address offset: 0x1C */
    __IO uint32_t CMPCONR;       /*!< TSC COMP control register,                               Address offset: 0x20 */
    uint32_t RESERVED[23];       /*!< Reserved,                                             Address offset: 0x24-7C */
    __IO uint32_t CFGR[24];      /*!< TSC config register,                                  Address offset: 0x80-DC */
    uint32_t RESERVED1[8];       /*!< Reserved,                                                Address offset: 0x28 */
    __IO uint32_t DR[24];        /*!< TSC data register,                                   ddress offset: 0x100-15C */
    uint32_t RESERVED2[8];       /*!< Reserved,                                           Address offset: 0x160-17C */
    __IO uint32_t OTR[24];       /*!< TSC overflow trigger registe,                       Address offset: 0x180-1DC */
} TSC_TypeDef;
...
typedef struct
{
  __IO uint32_t CR0;             /*!< KBCU Control register 0,                                 Address offset: 0x00 */
  __IO uint32_t CR1;             /*!< KBCU Control register 0,                                 Address offset: 0x04 */
  __IO uint32_t CR2;             /*!< Reserved,                                                Address offset: 0x08 */
  __IO uint32_t IER;             /*!< KBCU interrupt enable register,                          Address offset: 0x0C */
  __IO uint32_t SR;              /*!< KBCU Status register,                                    Address offset: 0x10 */
  __IO uint32_t KSR[6];          /*!< KBCU Key Status register 0,                           Address offset: 0x14-28 */
  __IO uint32_t LEDR[8];         /*!< KBCU LED register 0,                                  Address offset: 0x2C-48 */  
  uint32_t   RESERVED1;          /*!< Reserved,                                                Address offset: 0x4C */  
  __IO uint16_t DCR;             /*!< KBCU DMA control register,                               Address offset: 0x50 */
  uint16_t   RESERVED2;          /*!< Reserved,                                                Address offset: 0x52 */
  __IO uint32_t DMAR;            /*!< KBCU DMA address for full transfer register,             Address offset: 0x54 */    
} KBCU_TypeDef;
...
typedef struct
{
  __IO uint32_t CR;              /*!< SLED Control register,                                   Address offset: 0x00 */
  __IO uint32_t SR;              /*!< SLED Status register,                                    Address offset: 0x04 */
  __IO uint32_t CDR;             /*!< SLED Clock divider register,                             Address offset: 0x08 */
  __IO uint32_t TCR;             /*!< SLED Time Code register,                                 Address offset: 0x0C */
  __IO uint32_t DR[2];           /*!< SLED Data register ,                                  Address offset: 0x10-14 */
  __IO uint32_t FCR;             /*!< SLED FIFO control register,                              Address offset: 0x18 */  
} SLED_TypeDef;
...
typedef struct
{
  ...
  __IO uint32_t COMER;           /*!< LCD COM enable register,                                 Address offset: 0x04 */
  __IO uint32_t SEGER;           /*!< LCD SEG enable register,                                 Address offset: 0x08 */
  __IO uint32_t RESERVED;        /*!< Reserved,                                                Address offset: 0x0C */
  __IO uint32_t SEGDR0;          /*!< LCD SEG data register 0,                                 Address offset: 0x10 */
  __IO uint32_t SEGDR1;          /*!< LCD SEG data register 1                                  Address offset: 0x14 */
  __IO uint32_t SEGDR2;          /*!< LCD SEG data register 2,                                 Address offset: 0x18 */
  __IO uint32_t SEGDR3;          /*!< LCD SEG data register 3,                                 Address offset: 0x1C */
  __IO uint32_t SEGDR4;          /*!< LCD SEG data register 4,                                 Address offset: 0x20 */
  __IO uint32_t SEGDR5;          /*!< LCD SEG data register 5,                                 Address offset: 0x24 */
  __IO uint32_t SEGDR6;          /*!< LCD SEG data register 6,                                 Address offset: 0x28 */
  __IO uint32_t SEGDR7;          /*!< LCD SEG data register 7,                                 Address offset: 0x2C */
} LCD_TypeDef;
/**
  * @}
  */
...
#define KBCU_BASE             (APBPERIPH_BASE + 0x00001C00)
...
#define USBRAM_BASE           (APBPERIPH_BASE + 0x00006000)
...
#define ADC2_BASE             (APBPERIPH_BASE + 0x00012000) 
...
#define SLED_BASE             (APBPERIPH_BASE + 0x00016800)
#define LCD_BASE              (APBPERIPH_BASE + 0x00016C00)
...
/********************  Bit definition for ADC_VREFSR register  ********************/
#define  ADC_VREFSR_RSS                      ((uint32_t)0x00000003)        /*!< Reference source selection */
#define  ADC_VREFSR_RSS_0                    ((uint32_t)0x00000001)        /*!< Reference source selection bit 0*/
#define  ADC_VREFSR_RSS_1                    ((uint32_t)0x00000002)        /*!< Reference source selection bit 1*/
...
#define  CRS_CR_TRIM                         ((uint32_t)0x00003F00)        /*!< PLL48 oscillator smooth trimming */
...
#define  DAC_CR_WAVE1                        ((uint32_t)0x000000C0)        /*!< WAVE1[1:0] (DAC channel1 noise/triangle wave */
...
#define  DAC_DHR12RD_DACC1DHR                ((uint32_t)0x00000FFF)        /*!< Dual DAC channel1 12-bit Right aligned data */
#define  DAC_DHR12RD_DACC2DHR                ((uint32_t)0x0FFF0000)        /*!< Dual DAC channel2 12-bit Right aligned data */

/*****************  Bit definition for DAC_DHR12L2 register  ******************/
#define  DAC_DHR12LD_DACC1DHR                ((uint32_t)0x0000FFF0)        /*!< Dual DAC channel1 12-bit Left aligned data */
#define  DAC_DHR12LD_DACC2DHR                ((uint32_t)0xFFF00000)        /*!< Dual DAC channel2 12-bit Left aligned data */

/******************  Bit definition for DAC_DHR8R2 register  ******************/
#define  DAC_DHR8RD_DACC1DHR                 ((uint32_t)0x000000FF)        /*!< Dual DAC channel1 8-bit Right aligned data */
#define  DAC_DHR8RD_DACC2DHR                 ((uint32_t)0x0000FF00)        /*!< Dual DAC channel2 8-bit Right aligned data */

/*******************  Bit definition for DAC_DOR1 register  *******************/
#define  DAC_DOR1_DACC1DOR                   ((uint32_t)0x00000FFF)        /*!<DAC channel1 data output */

/*******************  Bit definition for DAC_DOR2 register  *******************/
#define  DAC_DOR2_DACC1DOR                   ((uint32_t)0x00000FFF)        /*!<DAC channel2 data output */
...
#define  DBGMCU_APB1_FZ_DBG_KBCU_STOP        ((uint32_t)0x00000080)        /*!< KBCU stopped when core is halted */
...
#define  DBGMCU_APB1_FZ_DBG_I2C2_SMBUS_TIMEOUT    ((uint32_t)0x00400000)   /*!< I2C1 SMBUS timeout mode stopped when Core is halted */
...
#define  DBGMCU_APB2_FZ_DBG_SLED_STOP        ((uint32_t)0x04000000)        /*!< SLED counter stopped when core is halted */
#define  DBGMCU_APB2_FZ_DBG_LCD_STOP         ((uint32_t)0x08000000)        /*!< LCD counter stopped when core is halted */
...
/******************  Bit definition for OB_EUSER register  *********************/
#define  OB_EUSER_BOR                        ((uint32_t)0x0000000F)        /*!< BOR option bytes */
#define  OB_EUSER_nBOR                       ((uint32_t)0x000000F0)        /*!< BOR complemented option bytes */
...
#define  GPIO_CSR_CS_0                       ((uint32_t)0x00000001)
#define  GPIO_CSR_CS_1                       ((uint32_t)0x00000002)
#define  GPIO_CSR_CS_2                       ((uint32_t)0x00000004)
#define  GPIO_CSR_CS_3                       ((uint32_t)0x00000008)
#define  GPIO_CSR_CS_4                       ((uint32_t)0x00000010)
#define  GPIO_CSR_CS_5                       ((uint32_t)0x00000020)
#define  GPIO_CSR_CS_6                       ((uint32_t)0x00000040)
#define  GPIO_CSR_CS_7                       ((uint32_t)0x00000080)
#define  GPIO_CSR_CS_8                       ((uint32_t)0x00000100)
#define  GPIO_CSR_CS_9                       ((uint32_t)0x00000200)
#define  GPIO_CSR_CS_10                      ((uint32_t)0x00000400)
#define  GPIO_CSR_CS_11                      ((uint32_t)0x00000800)
#define  GPIO_CSR_CS_12                      ((uint32_t)0x00001000)
#define  GPIO_CSR_CS_13                      ((uint32_t)0x00002000)
#define  GPIO_CSR_CS_14                      ((uint32_t)0x00004000)
#define  GPIO_CSR_CS_15                      ((uint32_t)0x00008000)

/****************** Bit definition for GPIO_DCL register  ********************/
#define  GPIO_DCL_DC0                        ((uint32_t)0x0000000F)
#define  GPIO_DCL_DC1                        ((uint32_t)0x000000F0)
#define  GPIO_DCL_DC2                        ((uint32_t)0x00000F00)
#define  GPIO_DCL_DC3                        ((uint32_t)0x0000F000)
#define  GPIO_DCL_DC4                        ((uint32_t)0x000F0000)
#define  GPIO_DCL_DC5                        ((uint32_t)0x00F00000)
#define  GPIO_DCL_DC6                        ((uint32_t)0x0F000000)
#define  GPIO_DCL_DC7                        ((uint32_t)0xF0000000)

/****************** Bit definition for GPIO_DCH register  ********************/
#define  GPIO_DCH_DC8                        ((uint32_t)0x0000000F)
#define  GPIO_DCH_DC9                        ((uint32_t)0x000000F0)
#define  GPIO_DCH_DC10                       ((uint32_t)0x00000F00)
#define  GPIO_DCH_DC11                       ((uint32_t)0x0000F000)
#define  GPIO_DCH_DC12                       ((uint32_t)0x000F0000)
#define  GPIO_DCH_DC13                       ((uint32_t)0x00F00000)
#define  GPIO_DCH_DC14                       ((uint32_t)0x0F000000)
#define  GPIO_DCH_DC15                       ((uint32_t)0xF0000000)
...
/******************************************************************************/
/*                                                                            */
/*                        Keyboard Control Unit (KBCU)                        */
/*                                                                            */
/******************************************************************************/

/******************  Bit definition for KBCU_CR0 register  ********************/
#define  KBCU_CR0_EN                         ((uint32_t)0x00000001)        /*!< KBCU Enable */
#define  KBCU_CR0_BEN                        ((uint32_t)0x00000002)        /*!< Blink Enable */
#define  KBCU_CR0_CS                         ((uint32_t)0x0000003C)        /*!< Column Select */
#define  KBCU_CR0_KIP                        ((uint32_t)0x00000100)        /*!< Key Input Polarity */
#define  KBCU_CR0_COP                        ((uint32_t)0x00000400)        /*!< Column Output Polarity */
#define  KBCU_CR0_CMASK                      ((uint32_t)0x007F0000)        /*!< Column Mask */
#define  KBCU_CR0_CCR                        ((uint32_t)0x7F000000)        /*!< Column Cycle Register */
      
/******************  Bit definition for KBCU_CR1 register  ********************/
#define  KBCU_CR1_ARR                        ((uint32_t)0x000000FF)        /*!< Auto-reload Register */
#define  KBCU_CR1_PSC                        ((uint32_t)0x0000FF00)        /*!< Prescaler */
#define  KBCU_CR1_FC                         ((uint32_t)0x00FF0000)        /*!< Flicker Control */
#define  KBCU_CR1_DT                         ((uint32_t)0x07000000)        /*!< Dead Time */
      
/******************  Bit definition for KBCU_CR2 register  ********************/
#define  KBCU_CR2_SM                         ((uint32_t)0x00000001)        /*!< Scan Mode */
#define  KBCU_CR2_KSM                        ((uint32_t)0x00000002)        /*!< Key Scan Mode */
#define  KBCU_CR2_KAS                        ((uint32_t)0x0000000C)        /*!< Key Assignment */
#define  KBCU_CR2_KDT                        ((uint32_t)0x00000070)        /*!< Key Dead Time */
#define  KBCU_CR2_KDSL                       ((uint32_t)0x00000080)        /*!< Key Dead Scan Level */
#define  KBCU_CR2_KARR                       ((uint32_t)0x00FF0000)        /*!< Key Auto-reload Register */
#define  KBCU_CR2_KCCR                       ((uint32_t)0x7F000000)        /*!< Key Column Cycle Register */
      
/******************  Bit definition for KBCU_IER register  ********************/
#define  KBCU_IER_FRAMEIE                    ((uint32_t)0x00000001)        /*!< Frame Interrupt Enable */
#define  KBCU_IER_COLIE                      ((uint32_t)0x00000002)        /*!< Column Interrupt Enable */
#define  KBCU_IER_KEYIE                      ((uint32_t)0x00000004)        /*!< Key Interrupt Enable */
#define  KBCU_IER_FRAME                      ((uint32_t)0x00FF0000)        /*!< Frame Count */
      
/******************  Bit definition for KBCU_SR register  *********************/
#define  KBCU_SR_FRAMEF                      ((uint32_t)0x00000001)        /*!< Frame Flag */
#define  KBCU_SR_COLF                        ((uint32_t)0x00000002)        /*!< Column Flag */
#define  KBCU_SR_KEYF                        ((uint32_t)0xFFFFFF00)        /*!< Key Flags */
      
/******************  Bit definition for KBCU_DCR register  ********************/
#define  KBCU_DCR_DBA                        ((uint32_t)0x0000001F)        /*!< DMA Base Address */
#define  KBCU_DCR_DBL                        ((uint32_t)0x00001F00)        /*!< DMA Burst Length */
...
#define  PWR_CR_LDOUSBEN                     ((uint32_t)0x010000)          /*!< USB voltage regulator enable */
#define  PWR_CR_USBPHYEPWR                   ((uint32_t)0x020000)          /*!< USBPHY power supply selection */
#define  PWR_CR_LDOUSBVS                     ((uint32_t)0x0C0000)          /*!< LDOUSBVS[1:0] bits (LDOUSB OUTPUT VDD Selection)*/
#define  PWR_CR_LDOUSBVS_0                   ((uint32_t)0x040000)          /*!< Bit 0 */
#define  PWR_CR_LDOUSBVS_1                   ((uint32_t)0x080000)          /*!< Bit 1 */
/* LDOUSBVS configuration */
#define  PWR_CR_LDOUSBVS_3_3                 ((uint32_t)0x000000)          /*!< PVD level 0 */
#define  PWR_CR_LDOUSBVS_3_0                 ((uint32_t)0x040000)          /*!< PVD level 1 */
#define  PWR_CR_LDOUSBVS_4_0                 ((uint32_t)0x080000)          /*!< PVD level 2 */
#define  PWR_CR_LDOUSBVS_2_0                 ((uint32_t)0x0C0000)          /*!< PVD level 3 */
...
/*******************  Bit definition for PWR_SUPR register  *******************/
#define  PWR_SUPR_SUP                        ((uint32_t)0xFFFFFF)          /*!< SUP[23:0] bits */
#define  PWR_SUPR_SUP_1                      ((uint32_t)0x000001)          /*!< Enable SUP pin 1 */
#define  PWR_SUPR_SUP_2                      ((uint32_t)0x000002)          /*!< Enable SUP pin 2 */
#define  PWR_SUPR_SUP_3                      ((uint32_t)0x000004)          /*!< Enable SUP pin 3 */
#define  PWR_SUPR_SUP_4                      ((uint32_t)0x000008)          /*!< Enable SUP pin 4 */
#define  PWR_SUPR_SUP_5                      ((uint32_t)0x000010)          /*!< Enable SUP pin 5 */
#define  PWR_SUPR_SUP_6                      ((uint32_t)0x000020)          /*!< Enable SUP pin 6 */
#define  PWR_SUPR_SUP_7                      ((uint32_t)0x000040)          /*!< Enable SUP pin 7 */
#define  PWR_SUPR_SUP_8                      ((uint32_t)0x000080)          /*!< Enable SUP pin 8 */
#define  PWR_SUPR_SUP_9                      ((uint32_t)0x000100)          /*!< Enable SUP pin 9 */
#define  PWR_SUPR_SUP_10                     ((uint32_t)0x000200)          /*!< Enable SUP pin 10 */
#define  PWR_SUPR_SUP_11                     ((uint32_t)0x000400)          /*!< Enable SUP pin 11 */
#define  PWR_SUPR_SUP_12                     ((uint32_t)0x000800)          /*!< Enable SUP pin 12 */
#define  PWR_SUPR_SUP_13                     ((uint32_t)0x001000)          /*!< Enable SUP pin 13 */
#define  PWR_SUPR_SUP_14                     ((uint32_t)0x002000)          /*!< Enable SUP pin 14 */
#define  PWR_SUPR_SUP_15                     ((uint32_t)0x004000)          /*!< Enable SUP pin 15 */
#define  PWR_SUPR_SUP_16                     ((uint32_t)0x008000)          /*!< Enable SUP pin 16 */
#define  PWR_SUPR_SUP_17                     ((uint32_t)0x010000)          /*!< Enable SUP pin 17 */
#define  PWR_SUPR_SUP_18                     ((uint32_t)0x020000)          /*!< Enable SUP pin 18 */
#define  PWR_SUPR_SUP_19                     ((uint32_t)0x040000)          /*!< Enable SUP pin 19 */
#define  PWR_SUPR_SUP_20                     ((uint32_t)0x080000)          /*!< Enable SUP pin 20 */
#define  PWR_SUPR_SUP_21                     ((uint32_t)0x100000)          /*!< Enable SUP pin 21 */
#define  PWR_SUPR_SUP_22                     ((uint32_t)0x200000)          /*!< Enable SUP pin 22 */
#define  PWR_SUPR_SUP_23                     ((uint32_t)0x400000)          /*!< Enable SUP pin 23 */
#define  PWR_SUPR_SUP_24                     ((uint32_t)0x800000)          /*!< Enable SUP pin 24 */
...
#define  RCC_CFGR_MCO_HSI16                  ((uint32_t)0x01000000)        /*!< HSI16 clock selected as MCO source */
...
#define  RCC_CFGR_MCO_PLL48                  ((uint32_t)0x08000000)        /*!< PLL48 clock selected as MCO source */
...
#define  RCC_CIR_PLL48RDYF                   ((uint32_t)0x00000040)        /*!< PLL48 Ready Interrupt flag */
...
#define  RCC_CIR_PLL48RDYIE                  ((uint32_t)0x00004000)        /*!< PLL48 Ready Interrupt Enable */
#define  RCC_CIR_LSIRDYC                     ((uint32_t)0x00010000)        /*!< LSI Ready Interrupt Clear */
#define  RCC_CIR_LSERDYC                     ((uint32_t)0x00020000)        /*!< LSE Ready Interrupt Clear */
#define  RCC_CIR_HSIRDYC                     ((uint32_t)0x00040000)        /*!< HSI Ready Interrupt Clear */
#define  RCC_CIR_HSERDYC                     ((uint32_t)0x00080000)        /*!< HSE Ready Interrupt Clear */
#define  RCC_CIR_PLLRDYC                     ((uint32_t)0x00100000)        /*!< PLL Ready Interrupt Clear */
#define  RCC_CIR_PLL48RDYC                   ((uint32_t)0x00400000)        /*!< PLL48 Ready Interrupt Clear */
#define  RCC_CIR_CSSC                        ((uint32_t)0x00800000)        /*!< Clock Security System Interrupt Clear */

/*****************  Bit definition for RCC_APB2RSTR register  *****************/
#define  RCC_APB2ENR_SYSCFGRST               ((uint32_t)0x00000001)        /*!< SYSCFG and comparator clock reset */
#define  RCC_APB2ENR_ADC1RST                 ((uint32_t)0x00000200)        /*!< ADC1 clock reset */
#define  RCC_APB2ENR_ADC2RST                 ((uint32_t)0x00000400)        /*!< ADC2 clock reset */
#define  RCC_APB2ENR_TIM1RST                 ((uint32_t)0x00000800)        /*!< TIM1 clock reset */
#define  RCC_APB2ENR_SPI1RST                 ((uint32_t)0x00001000)        /*!< SPI1 clock reset */
#define  RCC_APB2ENR_USART1RST               ((uint32_t)0x00004000)        /*!< USART1 clock reset */
#define  RCC_APB2ENR_TIM16RST                ((uint32_t)0x00020000)        /*!< TIM16 clock reset */
#define  RCC_APB2ENR_TIM17RST                ((uint32_t)0x00040000)        /*!< TIM17 clock reset */
#define  RCC_APB2ENR_DBGMCURST               ((uint32_t)0x00400000)        /*!< DBGMCU clock reset */
#define  RCC_APB2ENR_SLEDRST                 ((uint32_t)0x04000000)        /*!< SLEDEN  clock reset */
#define  RCC_APB2ENR_LCDRST                  ((uint32_t)0x08000000)        /*!< LCDEN clock reset */


/*****************  Bit definition for RCC_APB1RSTR register  *****************/
#define  RCC_APB1ENR_TIM2RST                 ((uint32_t)0x00000001)        /*!< Timer 2 clock reset */
#define  RCC_APB1ENR_TIM3RST                 ((uint32_t)0x00000002)        /*!< Timer 3 clock reset */
#define  RCC_APB1ENR_TIM6RST                 ((uint32_t)0x00000010)        /*!< Timer 6 clock reset */
#define  RCC_APB1ENR_KBCURST                 ((uint32_t)0x00000080)        /*!< KBUCU clock reset */
#define  RCC_APB1ENR_WWDGRST                 ((uint32_t)0x00000800)        /*!< Window Watchdog clock reset */
#define  RCC_APB1ENR_SPI2RST                 ((uint32_t)0x00004000)        /*!< SPI2 clock reset */
#define  RCC_APB1ENR_USART2RST               ((uint32_t)0x00020000)        /*!< USART2 clock reset */
#define  RCC_APB1ENR_I2C1RST                 ((uint32_t)0x00200000)        /*!< I2C1 clock reset */
#define  RCC_APB1ENR_I2C2RST                 ((uint32_t)0x00400000)        /*!< I2C2 clock reset */
#define  RCC_APB1ENR_USBRST                  ((uint32_t)0x00800000)        /*!< USB clock reset */
#define  RCC_APB1ENR_CRSRST                  ((uint32_t)0x08000000)        /*!< CRS clock reset */
#define  RCC_APB1ENR_PWRRST                  ((uint32_t)0x10000000)        /*!< PWR clock reset */
#define  RCC_APB1ENR_DACRST                  ((uint32_t)0x20000000)        /*!< DAC clock reset */
...
#define  RCC_APB2ENR_SYSCFGEN                ((uint32_t)0x00000001)        /*!< SYSCFG and comparator clock enable */
...
#define  RCC_APB2ENR_SLEDEN                  ((uint32_t)0x04000000)        /*!< SLEDEN  clock enable */
#define  RCC_APB2ENR_LCDEN                   ((uint32_t)0x08000000)        /*!< LCDEN clock enable */

/*****************  Bit definition for RCC_APB1ENR register  ******************/
#define  RCC_APB1ENR_TIM2EN                  ((uint32_t)0x00000001)        /*!< Timer 2 clock enable */
#define  RCC_APB1ENR_TIM3EN                  ((uint32_t)0x00000002)        /*!< Timer 3 clock enable */
#define  RCC_APB1ENR_TIM6EN                  ((uint32_t)0x00000010)        /*!< Timer 6 clock enable */
#define  RCC_APB1ENR_KBCUEN                  ((uint32_t)0x00000080)        /*!< KBUCU clock enable */
...
#define  RCC_CSR_V15PWRRSTF                  ((uint32_t)0x00800000)        /*!< V1.5 power domain reset flag */
...
#define  RCC_CFGR3_TIM6SW                    ((uint32_t)0x03000000)        /*!< TIM6SW[1:0] bits */
#define  RCC_CFGR3_TIM6SW_0                  ((uint32_t)0x01000000)        /*!< Bit 0 */
#define  RCC_CFGR3_TIM6SW_1                  ((uint32_t)0x02000000)        /*!< Bit 1 */
#define  RCC_CFGR3_LCDSW                     ((uint32_t)0x08000000)        /*!< LCDSW bits */


/*******************  Bit definition for RCC_CR2 register  ********************/
#define  RCC_CR2_PLL48ON                     ((uint32_t)0x00010000)        /*!< Internal High Speed PLL48MHz clock enable */
#define  RCC_CR2_PLL48RDY                    ((uint32_t)0x00020000)        /*!< Internal High Speed PLL48MHz clock ready flag */
...
/******************************************************************************/
/*                                                                            */
/*                       Serial Peripheral Interface (SLED)                   */
/*                                                                            */
/******************************************************************************/
/*******************  Bit definition for SLED_CR register  ********************/
#define  SLED_CR_EN                          ((uint32_t)0x00000001)        /*!< SLED Enable */
#define  SLED_CR_SYNCEN                      ((uint32_t)0x00000008)        /*!< Sync Enable */
#define  SLED_CR_RSTSTS                      ((uint32_t)0x00000100)        /*!< RESET status */
#define  SLED_CR_IDLESTS                     ((uint32_t)0x00000200)        /*!< IDLE status*/
#define  SLED_CR_SYNCSTS                     ((uint32_t)0x00000400)        /*!< SYNC status */
#define  SLED_CR_DMAEN1                      ((uint32_t)0x00010000)        /*!< SLED1 DMA Enable */
#define  SLED_CR_INTEN1                      ((uint32_t)0x00020000)        /*!< SLED1 Interrupt Enable */
#define  SLED_CR_RSTSTR1                     ((uint32_t)0x00100000)        /*!< SLED1 reset start */
#define  SLED_CR_DMAEN2                      ((uint32_t)0x01000000)        /*!< SLED2 DMA Enable */
#define  SLED_CR_INTEN2                      ((uint32_t)0x02000000)        /*!< SLED2 Interrupt Enable */
#define  SLED_CR_RSTSTR2                     ((uint32_t)0x10000000)        /*!< SLED2 reset start */             

/*******************  Bit definition for SLED_SR register  ********************/
#define  SLED_SR_BUSY1                       ((uint32_t)0x00010000)        /*!< SLED1 busy flag */
#define  SLED_SR_INT1                        ((uint32_t)0x00200000)        /*!< SLED1 Interrupt flag */
#define  SLED_SR_BUSY2                       ((uint32_t)0x01000000)        /*!< SLED2 busy flag */
#define  SLED_SR_INT2                        ((uint32_t)0x20000000)        /*!< SLED2 Interrupt flag */

/*******************  Bit definition for SLED_TCR register  ********************/
#define  SLED_TCR_PSC                        ((uint32_t)0x00000003)        /*!< Clock prescaler */
#define  SLED_TCR_BRD                        ((uint32_t)0x00001F00)        /*!< Baud rate */

/*******************  Bit definition for SLED_TCR register  ********************/
#define  SLED_TCR_T0H                        ((uint32_t)0x0000001F)        /*!< T0 duty cycle */
#define  SLED_TCR_T1H                        ((uint32_t)0x00001F00)        /*!< T1 duty cycle */
#define  SLED_TCR_TRST                       ((uint32_t)0x00FF0000)        /*!< RESET duty cycle */

/*******************  Bit definition for SLED_FCR register  ********************/
#define  SLED_FCR_FRST                       ((uint32_t)0x00000001)        /*!< FIFO reset */
#define  SLED_FCR_FTLS                       ((uint32_t)0x000000C0)        /*!< FIFO trigger int level */
#define  SLED_FCR_FCNT1                      ((uint32_t)0x00070000)        /*!< SLED1 FIFO cnt */
#define  SLED_FCR_FCNT2                      ((uint32_t)0x07000000)        /*!< SLED2 FIFO cnt */
...
#define  SYSCFG_CFGR2_LOCKUP_LOCK            ((uint32_t)0x00000001)        /*!< Enables and locks the PVD connection with Timer1, Timer16 and Timer17 Break
                                                                                  Input and also the PVD_EN and PVDSEL[2:0] bits of the Power Control Interface */
#define  SYSCFG_CFGR2_PVD_LOCK               ((uint32_t)0x00000004)        /*!< Enables and locks the LOCKUP (Hardfault) output of CortexM0 with Break Input 
                                                                                  of Timer1, Timer16 and Timer17 */

/*****************  Bit definition for SYSCFG_CFGR3 register  ****************/
#define  SYSCFG_CFGR3_DMA_CH1REQ             ((uint32_t)0x0000003F)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH1REQ_0           ((uint32_t)0x00000001)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH1REQ_1           ((uint32_t)0x00000002)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH1REQ_2           ((uint32_t)0x00000004)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH1REQ_3           ((uint32_t)0x00000008)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH1REQ_4           ((uint32_t)0x00000010)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH1REQ_5           ((uint32_t)0x00000020)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH2REQ             ((uint32_t)0x00003F00)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH2REQ_0           ((uint32_t)0x00000100)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH2REQ_1           ((uint32_t)0x00000200)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH2REQ_2           ((uint32_t)0x00000400)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH2REQ_3           ((uint32_t)0x00000800)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH2REQ_4           ((uint32_t)0x00001000)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH2REQ_5           ((uint32_t)0x00002000)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH3REQ             ((uint32_t)0x003F0000)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH3REQ_0           ((uint32_t)0x00010000)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH3REQ_1           ((uint32_t)0x00020000)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH3REQ_2           ((uint32_t)0x00040000)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH3REQ_3           ((uint32_t)0x00080000)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH3REQ_4           ((uint32_t)0x00100000)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH3REQ_5           ((uint32_t)0x00200000)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH4REQ             ((uint32_t)0x3F000000)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH4REQ_0           ((uint32_t)0x01000000)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH4REQ_1           ((uint32_t)0x02000000)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH4REQ_2           ((uint32_t)0x04000000)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH4REQ_3           ((uint32_t)0x08000000)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH4REQ_4           ((uint32_t)0x10000000)        /*!<  */
#define  SYSCFG_CFGR3_DMA_CH4REQ_5           ((uint32_t)0x20000000)        /*!<  */

/*****************  Bit definition for SYSCFG_CFGR4 register  ****************/
#define  SYSCFG_CFGR4_DMA_CH5REQ             ((uint32_t)0x0000003F)        /*!<  */
#define  SYSCFG_CFGR4_DMA_CH5REQ_0           ((uint32_t)0x00000001)        /*!<  */
#define  SYSCFG_CFGR4_DMA_CH5REQ_1           ((uint32_t)0x00000002)        /*!<  */
#define  SYSCFG_CFGR4_DMA_CH5REQ_2           ((uint32_t)0x00000004)        /*!<  */
#define  SYSCFG_CFGR4_DMA_CH5REQ_3           ((uint32_t)0x00000008)        /*!<  */
#define  SYSCFG_CFGR4_DMA_CH5REQ_4           ((uint32_t)0x00000010)        /*!<  */
#define  SYSCFG_CFGR4_DMA_CH5REQ_5           ((uint32_t)0x00000020)        /*!<  */
#define  SYSCFG_CFGR4_DMA_CH6REQ             ((uint32_t)0x00003F00)        /*!<  */
#define  SYSCFG_CFGR4_DMA_CH6REQ_0           ((uint32_t)0x00000100)        /*!<  */
#define  SYSCFG_CFGR4_DMA_CH6REQ_1           ((uint32_t)0x00000200)        /*!<  */
#define  SYSCFG_CFGR4_DMA_CH6REQ_2           ((uint32_t)0x00000400)        /*!<  */
#define  SYSCFG_CFGR4_DMA_CH6REQ_3           ((uint32_t)0x00000800)        /*!<  */
#define  SYSCFG_CFGR4_DMA_CH6REQ_4           ((uint32_t)0x00001000)        /*!<  */
#define  SYSCFG_CFGR4_DMA_CH6REQ_5           ((uint32_t)0x00002000)        /*!<  */
...
#define TIM_OR_TI1_RMP                       ((uint16_t)0x0003)            /*!< TI1_RMP[1:0] bits (TIM16/17 Input 1 remap) */
#define TIM_OR_TI1_RMP_0                     ((uint16_t)0x0001)            /*!< Bit 0 */
#define TIM_OR_TI1_RMP_1                     ((uint16_t)0x0002)            /*!< Bit 1 */
...
#define  LCD_CR_EN                           ((uint32_t)0x00000001)        /*!< LCD enable */
#define  LCD_CR_DM                           ((uint32_t)0x00000006)        /*!< Display mode selection */
#define  LCD_CR_DUTY                         ((uint32_t)0x00000018)        /*!< Duty cycle selection */
#define  LCD_CR_PS                           ((uint32_t)0x00000100)        /*!< Power selection */
#define  LCD_CR_TVS                          ((uint32_t)0x00001E00)        /*!< Voltage selection */
#define  LCD_CR_BIAS                         ((uint32_t)0x00006000)        /*!< Bias voltage selection */
#define  LCD_CR_FCM                          ((uint32_t)0x00010000)        /*!< Charging mode selection */
#define  LCD_CR_FCT                          ((uint32_t)0x00060000)        /*!< Charging time selection */
#define  LCD_CR_RM                           ((uint32_t)0x00300000)        /*!< Divider resistance selection */
#define  LCD_CR_PSC                          ((uint32_t)0x07000000)        /*!< Prescaler value */
