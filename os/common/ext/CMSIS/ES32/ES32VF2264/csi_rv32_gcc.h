 ...
 */
__ALWAYS_STATIC_INLINE void __enable_irq_(void)
{
...
/**
  ...
  Can only be executed in Privileged modes.
 */
__ALWAYS_STATIC_INLINE void __disable_irq_(void)
{
 ...
 */
__STATIC_INLINE uint8_t __es_get_PMPxCFG(uint32_t idx)
{
    uint32_t pmpcfgx = 0;
 ...
 */
__STATIC_INLINE void __es_set_PMPxCFG(uint32_t idx, uint8_t pmpxcfg)
{
    uint32_t pmpcfgx = 0;
...
/**
  ...
  \return               PMPADDRx Register value
 */
__STATIC_INLINE uint32_t __es_get_PMPADDRx(uint32_t idx)
{
    switch (idx) {
...
/**
  ...
  \param [in]    pmpaddr  PMPADDRx Register value to set
 */
__STATIC_INLINE void __es_set_PMPADDRx(uint32_t idx, uint32_t pmpaddr)
{
    switch (idx) {
...
{
    __ASM volatile("csrs mstatus, 8");//__enable_irq();
}
...
{
    __ASM volatile("csrc mstatus, 8");//__disable_irq();
}
 ...
 */
__ALWAYS_STATIC_INLINE void __NOP_(void)
{
    __ASM volatile("nop");
}
 ...
 */
__ALWAYS_STATIC_INLINE void __WFI_(void)
{
    __ASM volatile("wfi");
}
 ...
 */
__ALWAYS_STATIC_INLINE uint32_t __REV_(uint32_t value)
{
...
/**
  ...
  \return               Reversed value
 */
__ALWAYS_STATIC_INLINE uint32_t __REV16_(uint32_t value)
{
    uint32_t result;
...
/**
  ...
  \return               Reversed value
 */
__ALWAYS_STATIC_INLINE int32_t __REVSH_(int32_t value)
{
 ...
 */
__ALWAYS_STATIC_INLINE uint32_t __ROR_(uint32_t op1, uint32_t op2)
{
...
/**
  ...
  \return               Reversed value
 */
__ALWAYS_STATIC_INLINE uint32_t __RBIT_(uint32_t value)
{
    uint32_t result;
 ...
 */
__ALWAYS_STATIC_INLINE int32_t __SSAT_(int32_t x, uint32_t y)
{
...
/**
  ...
  \return             Saturated value
 */
__ALWAYS_STATIC_INLINE uint32_t __USAT_(uint32_t value, uint32_t sat)
{
    uint32_t result;
...
__ALWAYS_STATIC_INLINE uint32_t __SSAT16(int32_t x, const uint32_t y)
{
    ...
    r = __SSAT_((((int32_t)x << 16) >> 16), y) & (int32_t)0x0000FFFF;
    s = __SSAT_((((int32_t)x) >> 16), y) & (int32_t)0x0000FFFF;
...
__ALWAYS_STATIC_INLINE uint32_t __QADD8(uint32_t x, uint32_t y)
{
    ...
    r = __SSAT_(((((int32_t)x << 24) >> 24) + (((int32_t)y << 24) >> 24)), 8) & (int32_t)0x000000FF;
    s = __SSAT_(((((int32_t)x << 16) >> 24) + (((int32_t)y << 16) >> 24)), 8) & (int32_t)0x000000FF;
    t = __SSAT_(((((int32_t)x <<  8) >> 24) + (((int32_t)y <<  8) >> 24)), 8) & (int32_t)0x000000FF;
    u = __SSAT_(((((int32_t)x) >> 24) + (((int32_t)y) >> 24)), 8) & (int32_t)0x000000FF;
...
__ALWAYS_STATIC_INLINE uint32_t __QADD16(uint32_t x, uint32_t y)
{
    ...
    r = __SSAT_(((((int32_t)x << 16) >> 16) + (((int32_t)y << 16) >> 16)), 16) & (int32_t)0x0000FFFF;
    s = __SSAT_(((((int32_t)x) >> 16) + (((int32_t)y) >> 16)), 16) & (int32_t)0x0000FFFF;
...
__ALWAYS_STATIC_INLINE uint32_t __QASX(uint32_t x, uint32_t y)
{
    ...
    r = __SSAT_(((((int32_t)x << 16) >> 16) - (((int32_t)y) >> 16)), 16) & (int32_t)0x0000FFFF;
    s = __SSAT_(((((int32_t)x) >> 16) + (((int32_t)y << 16) >> 16)), 16) & (int32_t)0x0000FFFF;
...
//#define __disable_irq __disable_irq_
//#define __enable_irq __enable_irq_
