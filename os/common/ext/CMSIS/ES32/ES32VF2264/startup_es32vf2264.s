/*********************************************************************************
 * file       : startup_es32vf2264.S
 * description: es32vf2264 Device Startup File
 * author     : AE Team
 * data       : 01 Dec. 2022
 * note
 *          Change Logs:
 *          Date            Author          Notes
 *          01 Dec. 2022    AE Team         The first version
 *
...
/* Configure word checking */
  .section  .text.CFG_Check_Handler
  .weak  CFG_Check
  .type  CFG_Check, %function
CFG_Check:
  sw ra, -4(sp)
  sw sp, -8(sp)

LABLE_CHECK_CFG_WORD0:
  li  a1, 0x00000000
  li  a2, 0x00000000
  li  a0, 0x00040000 /* CFG_WORD0 address */
  lhu a1, (a0)
  li  a0, 0x00040002 /* CFG_WORD0_N address */
  lhu a2, (a0)
  xor a1, a1, a2
  li  a2, 0x0000FFFF
  beq a1, a2, LABLE_CHECK_CFG_PASS
  j   __exit

LABLE_CHECK_CFG_PASS:
  lw ra, -4(sp)
  lw sp, -8(sp)
  jr ra

.size  CFG_Check, .-CFG_Check

  .align  6
  .weak   Default_Handler
#ifdef __GCC__     /* GCC Compiler */
