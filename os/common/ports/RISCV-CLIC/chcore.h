 ...
 */
#define PORT_CORE_VARIANT_NAME          "RV32EMC"
...
struct port_intctx {
    ...
    uint32_t s0;      /* x8  - s0/fp  - saved register 0 or frame pointer   */
...
#define PORT_SETUP_CONTEXT(tp, wbase, wtop, pf, arg)                           \
  {                                                                            \
    ...
    (tp)->ctx.sp->epc = (uint32_t)_port_thread_start;                          \
 ...
 */
#define port_switch(ntp, otp) switch_thread_by_handler(ntp, otp)
