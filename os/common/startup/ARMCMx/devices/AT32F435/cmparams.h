...
/**
 * @file        AT32F435/cmparams.h
 * @brief       ARM Cortex-M4F parameters for the Artery AT32F435
 *
 * @defgroup    ARMCMx_AT32F435 Artery AT32F405 Specific Parameters
 * @ingroup     ARMCMx_SPECIFIC
 * @details     This file contains the Cortex-M4F specific parameters for the
 *              Artery AT32F435 platform.
 * @{
 */
