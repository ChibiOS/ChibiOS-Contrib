...
/**
 * @file    M251/hal_efl_lld.h
 * @brief   M251/M252 Embedded Flash subsystem low level driver header.
 *
 * @addtogroup HAL_EFL
 * @{
 */
...
/**
 * @brief   Size of a flash erase page in bytes.
 */
#define M251_FLASH_PAGE_SIZE                   0x200UL
