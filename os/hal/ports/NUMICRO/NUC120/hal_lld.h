 ...
 * @{
 */
#if defined(NUC120LE3AN) || defined(__DOXYGEN__)
#define PLATFORM_NAME           "NUC120LE3AN NUC120 Cortex M0 USB Micro"
#define NUC120xxxAN
#define NUC123xxxANx
#undef NUC123xxxAEx
#define NUC123_FLASH_SIZE 0x20000
#else
#error "NUC120 device unsupported or not specified"
#endif
...
#define NUC123_PLLCLK NUC123_HCLK
...
/* Various helpers */
#include "NUC120.h"
#include "nuc120_isr.h"
#include "nuc120_registry.h"
#include "nvic.h"
