...
#ifndef HAL_SPI_V2_LLD_SERCOM_H
#define HAL_SPI_V2_LLD_SERCOM_H
...
#if !defined(SAM_SPI6_DMATX_CHANNEL)
#define SAM_SPI6_DMATX_CHANNEL SAM_DMAC_NUM_MAX
#endif

#if !defined(SAM_SPI6_DMARX_CHANNEL)
#define SAM_SPI6_DMARX_CHANNEL SAM_DMAC_NUM_MAX
#endif

#if !defined(SAM_SPI6_DMA_PRIO)
#define SAM_SPI6_DMA_PRIO 1
#endif

#if !defined(SAM_SPI7_DMATX_CHANNEL)
#define SAM_SPI7_DMATX_CHANNEL SAM_DMAC_NUM_MAX
#endif

#if !defined(SAM_SPI7_DMARX_CHANNEL)
#define SAM_SPI7_DMARX_CHANNEL SAM_DMAC_NUM_MAX
#endif

#if !defined(SAM_SPI7_DMA_PRIO)
#define SAM_SPI7_DMA_PRIO 1
#endif
/*===========================================================================*/
...
/**
 * @brief   SPI7 driver identifier.
 */
#if (SAM_SPI_USE_SERCOM6 == TRUE) || defined(__DOXYGEN__)
extern SPIDriver SPID7;
#endif

/**
 * @brief   SPI8 driver identifier.
 */
#if (SAM_SPI_USE_SERCOM7 == TRUE) || defined(__DOXYGEN__)
...
typedef struct {
  /* CTRLA register,  */
  uint32_t ctrla;
  /* CTRLB register, MSSEN is disabled and AMODE is Masked*/
  uint32_t ctrlb;
  uint32_t freq;
  /* DIPO and DOPO from CTRLA refer to the SPI CTRLA Table */
  uint8_t dipo;
  uint8_t dopo;
} sercom_spi_config_t;
