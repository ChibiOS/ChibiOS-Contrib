...
PLATFORMSRC_CONTRIB := $(CHIBIOS)/os/hal/ports/common/ARMCMx/nvic.c \
               $(CHIBIOS_CONTRIB)/os/hal/ports/SAM/SAME54/sam_clk.c \
               $(CHIBIOS_CONTRIB)/os/hal/ports/SAM/SAME54/hal_lld.c \

# Required include directories.
PLATFORMINC_CONTRIB := $(CHIBIOS)/os/hal/ports/common/ARMCMx \
               $(CHIBIOS_CONTRIB)/os/hal/ports/SAM/SAME54
...
include $(CHIBIOS_CONTRIB)/os/hal/ports/SAM/LLD/DMACv2/driver.mk
...
include $(CHIBIOS_CONTRIB)/os/hal/ports/SAM/LLD/SPIv1/driver.mk
