...
void pwm_lld_start(PWMDriver *pwmp) {
  ...
  if (pwmp->state == PWM_STOP) {
    ...
    if (&PWMD1 == pwmp) {
      ...
      rccResetTIM1();
#if !defined(STM32_TIM1_SUPPRESS_ISR)
      eclicEnableVector(GD32_TIM1_UP_NUMBER, STM32_PWM_TIM1_IRQ_PRIORITY, STM32_PWM_TIM1_IRQ_TRIGGER);
      eclicEnableVector(GD32_TIM1_CC_NUMBER, STM32_PWM_TIM1_IRQ_PRIORITY, STM32_PWM_TIM1_IRQ_TRIGGER);
#endif
    ...
    if (&PWMD2 == pwmp) {
      ...
      rccResetTIM2();
#if !defined(STM32_TIM2_SUPPRESS_ISR)
      eclicEnableVector(GD32_TIM2_NUMBER, STM32_PWM_TIM2_IRQ_PRIORITY, STM32_PWM_TIM2_IRQ_TRIGGER);
#endif
    ...
    if (&PWMD3 == pwmp) {
      ...
      rccResetTIM3();
#if !defined(STM32_TIM3_SUPPRESS_ISR)
      eclicEnableVector(GD32_TIM3_NUMBER, STM32_PWM_TIM3_IRQ_PRIORITY, STM32_PWM_TIM3_IRQ_TRIGGER);
#endif
    ...
    if (&PWMD4 == pwmp) {
      ...
      rccResetTIM4();
#if !defined(STM32_TIM4_SUPPRESS_ISR)
      eclicEnableVector(GD32_TIM4_NUMBER, STM32_PWM_TIM4_IRQ_PRIORITY, STM32_PWM_TIM4_IRQ_TRIGGER);
#endif
    ...
    if (&PWMD5 == pwmp) {
      ...
      rccResetTIM5();
#if !defined(STM32_TIM5_SUPPRESS_ISR)
      eclicEnableVector(GD32_TIM5_NUMBER, STM32_PWM_TIM5_IRQ_PRIORITY, STM32_PWM_TIM5_IRQ_TRIGGER);
#endif
    ...
    if (&PWMD8 == pwmp) {
      ...
      rccResetTIM8();
#if !defined(STM32_TIM8_SUPPRESS_ISR)
      eclicEnableVector(GD32_TIM8_UP_NUMBER, STM32_PWM_TIM8_IRQ_PRIORITY, STM32_PWM_TIM8_IRQ_TRIGGER);
      eclicEnableVector(GD32_TIM8_CC_NUMBER, STM32_PWM_TIM8_IRQ_PRIORITY, STM32_PWM_TIM8_IRQ_TRIGGER);
#endif
