...
#elif EFR32_ST_USE_TIMER == 2
  #if defined(EFR32_LETIM2_IS_USED)
    #error "ST requires LETIM2 but the timer is already used"
  #else
    #define EFR32_LETIM2_IS_USED
  #endif

  #define EFR32_ST_TIM                         LETIMER1
#endif
...
static inline void st_lld_start_alarm(systime_t abstime) {
  ...
  EFR32_ST_TIM->IEN = _LETIMER_IEN_RESETVALUE;
  ...
  EFR32_ST_TIM->IEN = LETIMER_IEN_COMP0;
}
