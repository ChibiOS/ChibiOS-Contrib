...
PLATFORMSRC = ${CHIBIOS_CONTRIB}/os/hal/ports/common/RISCV-CLIC/eclic.c \
			$(CHIBIOS_CONTRIB)/os/hal/ports/ES32/ES32VF2264/hal_lld.c


# Required include directories
PLATFORMINC = ${CHIBIOS_CONTRIB}/os/hal/ports/common/RISCV-CLIC \
              $(CHIBIOS_CONTRIB)/os/hal/ports/ES32/ES32VF2264
...
include $(CHIBIOS_CONTRIB)/os/hal/ports/ES32/LLD/TIMv2/driver.mk
include $(CHIBIOS_CONTRIB)/os/hal/ports/ES32/LLD/SPIv1/driver.mk
include $(CHIBIOS_CONTRIB)/os/hal/ports/ES32/LLD/GPIOv2/driver.mk
