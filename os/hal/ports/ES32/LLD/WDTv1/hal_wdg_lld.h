 ...
 */
#if !defined(ES32_WDG_USE_WDT) || defined(__DOXYGEN__)
    #define ES32_WDG_USE_WDT                    FALSE
#endif

#if ES32_WDG_USE_LSE != TRUE
    #define ES32_WDG_USE_LSI                    TRUE
#endif
/** @} */
...
typedef struct
{
     ...
     * @details See the ES32 reference manual for details.
     */
    uint32_t    mr0;
    /**
