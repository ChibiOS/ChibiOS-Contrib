...
#if (ES32_GPT_USE_BFTM0 == TRUE) || defined(__DOXYGEN__)
#ifndef ES32_BFTM0_IRQ_VECTOR
    #error "ES32_BFTM0_IRQ_VECTOR is not defined"
#endif
OSAL_IRQ_HANDLER(ES32_BFTM0_IRQ_VECTOR)
{
    OSAL_IRQ_PROLOGUE();
...
#if (ES32_GPT_USE_BFTM1 == TRUE) || defined(__DOXYGEN__)
OSAL_IRQ_HANDLER(ES32_BFTM1_IRQ_VECTOR)
{
    OSAL_IRQ_PROLOGUE();
...
#if ES32_GPT_USE_BFTM0 == TRUE
    gptObjectInit(&GPTD_BFTM0);
    GPTD_BFTM0.BFTM = BFTM0;
#endif
#if ES32_GPT_USE_BFTM1 == TRUE
...
void gpt_lld_start(GPTDriver *gptp)
{
    if (gptp->state == GPT_STOP)
    {
        ...
        if (&GPTD_BFTM0 == gptp)
        {
            ...
            nvicEnableVector(BFTM0_IRQn, ES32_GPT_BFTM0_IRQ_PRIORITY);
        }
        ...
        if (&GPTD_BFTM1 == gptp)
        {
            ...
            nvicEnableVector(BFTM1_IRQn, ES32_GPT_BFTM1_IRQ_PRIORITY);
        }
