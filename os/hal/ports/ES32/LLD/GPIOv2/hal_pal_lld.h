...
#define PAL_ES32_MODE_INPUT            (1U << 0U)
#define PAL_ES32_MODE_OUTPUT           (2U << 0U)
#define PAL_ES32_MODE_ALTERNATE        (3U << 0U)
#define PAL_ES32_MODE_ANALOG           (0U << 0U)

#define PAL_ES32_OT_MASK               (1U << 2U)
#define PAL_ES32_OT_PUSHPULL           (0U << 2U)
#define PAL_ES32_OT_OPENDRAIN          (2U << 2U)

#define PAL_ES32_DS_MASK               (1U << 4U)
#define PAL_ES32_DS_8MA                (0U << 4U)
#define PAL_ES32_DS_16MA               (1U << 4U)
