...
#if NRF5_ICU_USE_GPIOTE_PPI
    nvicEnableVector(GPIOTE_IRQn, NRF52_ICU_GPIOTE_IRQ_PRIORITY);
#endif
#if NRF52_ICU_USE_TIMER0
    if (&ICUD1 == icup) {
      nvicEnableVector(TIMER0_IRQn, NRF52_ICU_TIMER0_IRQ_PRIORITY);
    }
#endif
#if NRF52_ICU_USE_TIMER1
    if (&ICUD2 == icup) {
      nvicEnableVector(TIMER1_IRQn, NRF52_ICU_TIMER1_IRQ_PRIORITY);
    }
#endif
#if NRF52_ICU_USE_TIMER2
    if (&ICUD3 == icup) {
      nvicEnableVector(TIMER2_IRQn, NRF52_ICU_TIMER2_IRQ_PRIORITY);
    }
#endif
#if NRF52_ICU_USE_TIMER3
    if (&ICUD4 == icup) {
      nvicEnableVector(TIMER3_IRQn, NRF52_ICU_TIMER3_IRQ_PRIORITY);
    }
#endif
#if NRF52_ICU_USE_TIMER4
    if (&ICUD5 == icup) {
      nvicEnableVector(TIMER4_IRQn, NRF52_ICU_TIMER4_IRQ_PRIORITY);
    }
#endif
