 ...
 */
#if !defined(NRF52_ICU_USE_TIMER0) || defined(__DOXYGEN__)
#define NRF52_ICU_USE_TIMER0               FALSE
#endif
 ...
 * @note    The default is @p TRUE.
 */
#if !defined(NRF52_ICU_USE_TIMER1) || defined(__DOXYGEN__)
#define NRF52_ICU_USE_TIMER1                FALSE
#endif
 ...
 * @note    The default is @p TRUE.
 */
#if !defined(NRF52_ICU_USE_TIMER2) || defined(__DOXYGEN__)
#define NRF52_ICU_USE_TIMER2                FALSE
#endif
 ...
 * @note    The default is @p TRUE.
 */
#if !defined(NRF52_ICU_USE_TIMER3) || defined(__DOXYGEN__)
#define NRF52_ICU_USE_TIMER3                FALSE
#endif
 ...
 * @note    The default is @p TRUE.
 */
#if !defined(NRF52_ICU_USE_TIMER4) || defined(__DOXYGEN__)
#define NRF52_ICU_USE_TIMER4                FALSE
#endif

/**
 * @brief   ICUD1 interrupt priority level setting.
 */
#if !defined(NRF52_ICU_TIMER0_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define NRF52_ICU_TIMER0_IRQ_PRIORITY         3
#endif

/**
 * @brief   ICUD2 interrupt priority level setting.
 */
#if !defined(NRF52_ICU_TIMER1_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define NRF52_ICU_TIMER1_IRQ_PRIORITY         3
#endif

/**
 * @brief   ICUD3 interrupt priority level setting.
 */
#if !defined(NRF52_ICU_TIMER2_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define NRF52_ICU_TIMER2_IRQ_PRIORITY         3
#endif

/**
 * @brief   ICUD4 interrupt priority level setting.
 */
#if !defined(NRF52_ICU_TIMER3_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define NRF52_ICU_TIMER3_IRQ_PRIORITY         3
#endif

/**
 * @brief   ICUD5 interrupt priority level setting.
 */
#if !defined(NRF52_ICU_TIMER4_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define NRF52_ICU_TIMER4_IRQ_PRIORITY         3
#endif
...
#if !NRF52_ICU_USE_TIMER0  && !NRF52_ICU_USE_TIMER1  &&                     \
    !NRF52_ICU_USE_TIMER2  && !NRF52_ICU_USE_TIMER3  &&                     \
    !NRF52_ICU_USE_TIMER4
#error "ICU driver activated but no TIMER peripheral assigned"
#endif

#if NRF52_ICU_USE_TIMER0 &&                                                 \
    !OSAL_IRQ_IS_VALID_PRIORITY(NRF52_ICU_TIMER0_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to TIMER0"
#endif

#if NRF52_ICU_USE_TIMER1 &&                                                 \
    !OSAL_IRQ_IS_VALID_PRIORITY(NRF52_ICU_TIMER1_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to TIMER1"
#endif

#if NRF52_ICU_USE_TIMER2 &&                                                 \
    !OSAL_IRQ_IS_VALID_PRIORITY(NRF52_ICU_TIMER2_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to TIMER2"
#endif

#if NRF52_ICU_USE_TIMER3 &&                                                 \
    !OSAL_IRQ_IS_VALID_PRIORITY(NRF52_ICU_TIMER3_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to TIMER3"
#endif

#if NRF52_ICU_USE_TIMER4 &&                                                  \
    !OSAL_IRQ_IS_VALID_PRIORITY(NRF52_ICU_TIMER4_IRQ_PRIORITY)
...
/*===========================================================================*/
#if NRF52_ICU_USE_TIMER0 && !defined(__DOXYGEN__)
extern ICUDriver ICUD1;
#endif

#if NRF52_ICU_USE_TIMER1 && !defined(__DOXYGEN__)
extern ICUDriver ICUD2;
#endif

#if NRF52_ICU_USE_TIMER2 && !defined(__DOXYGEN__)
extern ICUDriver ICUD3;
#endif

#if NRF52_ICU_USE_TIMER3 && !defined(__DOXYGEN__)
extern ICUDriver ICUD4;
#endif

#if NRF52_ICU_USE_TIMER4 && !defined(__DOXYGEN__)
