...
PLATFORMSRC += ${CHIBIOS_CONTRIB}/os/hal/ports/NRF5/NRF52832/hal_i2c_lld.c
endif
...
PLATFORMSRC += ${CHIBIOS_CONTRIB}/os/hal/ports/NRF5/NRF52832/hal_pwm_lld.c
endif
ifneq ($(findstring HAL_USE_ICU TRUE,$(HALCONF)),)
PLATFORMSRC += ${CHIBIOS_CONTRIB}/os/hal/ports/NRF5/NRF52832/hal_icu_lld.c
endif
else
PLATFORMSRC  = ${CHIBIOS}/os/hal/ports/common/ARMCMx/nvic.c \
               ${CHIBIOS_CONTRIB}/os/hal/ports/NRF5/NRF52832/hal_lld.c \
	       ...
	       ${CHIBIOS_CONTRIB}/os/hal/ports/NRF5/LLD/hal_rng_lld.c \
               ${CHIBIOS_CONTRIB}/os/hal/ports/NRF5/NRF52832/hal_i2c_lld.c \
	       ${CHIBIOS_CONTRIB}/os/hal/ports/NRF5/NRF52832/hal_pwm_lld.c \
	       ${CHIBIOS_CONTRIB}/os/hal/ports/NRF5/NRF52832/hal_icu_lld.c \
