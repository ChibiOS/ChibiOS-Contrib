...
#define I2C0_IRQ_PRI     NRF52_I2C_I2C0_IRQ_PRIORITY
#endif
#if NRF52_I2C_USE_I2C1
#define I2C1_IRQ_NUM     SPIM1_SPIS1_TWIM1_TWIS1_SPI1_TWI1_IRQn
#define I2C1_IRQ_PRI     NRF52_I2C_I2C1_IRQ_PRIORITY
#endif
 ...
 */
#if NRF52_I2C_USE_I2C0 || defined(__DOXYGEN__)
I2CDriver I2CD1;
#endif
 ...
 */
#if NRF52_I2C_USE_I2C1 || defined(__DOXYGEN__)
I2CDriver I2CD2;
#endif
