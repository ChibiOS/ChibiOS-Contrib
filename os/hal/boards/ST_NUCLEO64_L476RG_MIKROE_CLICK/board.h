...
#define GPIOB_W5500_RST             0U
#define GPIOB_PIN1                  1U
#define GPIOB_USER_UART_CTS         2U
#define GPIOB_ARD_D3                3U
#define GPIOB_SWO                   3U
#define GPIOB_ARD_D5                4U
#define GPIOB_ARD_D4                5U
#define GPIOB_ARD_D10               6U
#define GPIOB_SPI1_CS               6U
#define GPIOB_W5500_NSS             6U
#define GPIOB_PIN7                  7U
#define GPIOB_ARD_D15               8U
#define GPIOB_ARD_D14               9U
#define GPIOB_ARD_D6                10U
#define GPIOB_LPUART1_RX            10U
#define GPIOB_LPUART1_TX            11U
...
#define LINE_MODEM_STAT             PAL_LINE(GPIOA, 1U)
...
#define LINE_MODEM_RST              PAL_LINE(GPIOA, 4U)
...
#define LINE_W5500_INT              PAL_LINE(GPIOA, 10U)
#define LINE_SWDIO                  PAL_LINE(GPIOA, 13U)
#define LINE_SWCLK                  PAL_LINE(GPIOA, 14U)
#define LINE_ARD_A3                 PAL_LINE(GPIOB, 0U)
#define LINE_ACD12_IN15             PAL_LINE(GPIOB, 0U)
#define LINE_W5500_RST              PAL_LINE(GPIOB, 0U)
#define LINE_USER_UART_CTS          PAL_LINE(GPIOB, 2U)
...
#define LINE_W5500_NSS              PAL_LINE(GPIOB, 6U)
#define LINE_ARD_D15                PAL_LINE(GPIOB, 8U)
#define LINE_ARD_D14                PAL_LINE(GPIOB, 9U)
#define LINE_ARD_D6                 PAL_LINE(GPIOB, 10U)
#define LINE_LPUART1_RX             PAL_LINE(GPIOB, 10U)
#define LINE_LPUART1_TX             PAL_LINE(GPIOB, 11U)
 ...
 * PA1  - ARD_A1 ACD12_IN6 MODEM_STAT(input pulldown).
 * PA2  - ARD_D1 USART2_TX          (alternate 7).
 * PA3  - ARD_D0 USART2_RX          (alternate 7).
 * PA4  - ARD_A2 ACD12_IN9 MODEM_RST(output pushpull maximum).
 * PA5  - ARD_D13 LED_GREEN SPI1_SCK(alternate 5).
 * PA6  - ARD_D12 SPI1_MISO         (alternate 5).
 * PA7  - ARD_D11 SPI1_MOSI         (alternate 5).
 * PA8  - ARD_D7                    (analog).
 * PA9  - ARD_D8                    (analog).
 * PA10 - ARD_D2 W5500_INT          (input pullup).
 * PA11 - PIN11                     (analog).
 * PA12 - PIN12                     (analog).
 ...
 * GPIOB setup:
 *
 * PB0  - ARD_A3 ACD12_IN15 W5500_RST(output pushpull maximum).
 * PB1  - PIN1                      (analog).
 * PB2  - USER_UART_CTS             (input pullup).
 * PB3  - ARD_D3 SWO                (alternate 0).
 * PB4  - ARD_D5                    (analog).
 * PB5  - ARD_D4                    (analog).
 * PB6  - ARD_D10 SPI1_CS W5500_NSS (output pushpull maximum).
 * PB7  - PIN7                      (analog).
 * PB8  - ARD_D15                   (analog).
 * PB9  - ARD_D14                   (analog).
 * PB10 - ARD_D6 LPUART1_RX         (alternate 8).
 * PB11 - LPUART1_TX                (alternate 8).
 * PB12 - PIN12                     (analog).
 * PB13 - PIN13                     (analog).
 * PB14 - PIN14                     (analog).
 * PB15 - PIN15                     (analog).
...
#define VAL_GPIOB_MODER             (PIN_MODE_OUTPUT(GPIOB_ARD_A3) |        \
                                     ...
                                     PIN_MODE_INPUT(GPIOB_USER_UART_CTS) |  \
                                     PIN_MODE_ALTERNATE(GPIOB_ARD_D3) |     \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOB_ARD_D6) |     \
                                     PIN_MODE_ALTERNATE(GPIOB_LPUART1_TX) | \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_ARD_A3) |     \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_USER_UART_CTS) |\
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_LPUART1_TX) | \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_ARD_A3) |        \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOB_USER_UART_CTS) | \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOB_LPUART1_TX) |    \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_FLOATING(GPIOB_ARD_A3) |     \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOB_USER_UART_CTS) |\
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOB_LPUART1_TX) | \
...
#define VAL_GPIOB_ODR               (PIN_ODR_HIGH(GPIOB_ARD_A3) |           \
                                     ...
                                     PIN_ODR_HIGH(GPIOB_USER_UART_CTS) |    \
...
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_ARD_A3, 0U) |        \
                                     ...
                                     PIN_AFIO_AF(GPIOB_USER_UART_CTS, 0U) | \
...
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_ARD_D15, 0U) |       \
                                     ...
                                     PIN_AFIO_AF(GPIOB_ARD_D6, 8U) |        \
                                     PIN_AFIO_AF(GPIOB_LPUART1_TX, 8U) |    \
...
#define VAL_GPIOB_ASCR              (PIN_ASCR_DISABLED(GPIOB_ARD_A3) |      \
                                     ...
                                     PIN_ASCR_DISABLED(GPIOB_USER_UART_CTS) |\
                                     ...
                                     PIN_ASCR_DISABLED(GPIOB_LPUART1_TX) |  \
...
#define VAL_GPIOB_LOCKR             (PIN_LOCKR_DISABLED(GPIOB_ARD_A3) |     \
                                     ...
                                     PIN_LOCKR_DISABLED(GPIOB_USER_UART_CTS) |\
                                     ...
                                     PIN_LOCKR_DISABLED(GPIOB_LPUART1_TX) | \
