...
#define LINE_LED_LD2                PAL_LINE(GPIOB, 8U)
 ...
 * PB6  - PIN6                      (analog).
 * PB7  - PIN7                      (analog).
 * PB8  - LED LED_GREEN             (output pushpull high).
 * PB9  - PIN9                      (analog).
 * PB10 - PIN10                     (analog).
 * PB11 - PIN11                     (analog).
 * PB12 - PIN12                     (analog).
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_LED_LD2) |       \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_FLOATING(GPIOB_PIN0) |       \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOB_LED_LD2) |       \
...
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_LED_LD2, 0U) |          \
